 ...
 */
$format = '<input class="custom-control-input" type="checkbox" id="%1$s" name="%2$s" value="%3$s" %4$s />';
...
<fieldset id="<?php echo $id; ?>" class="<?php echo trim($class . ' form-check'); ?>"
	...
	<?php foreach ($options as $i => $option) : ?>
		<div class="custom-control custom-checkbox">
			...
			<label for="<?php echo $oid; ?>" class="custom-control-label"><?php echo $option->text; ?></label>
		</div>
	<?php endforeach; ?>
</fieldset>
